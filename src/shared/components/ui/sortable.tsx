...
import { useComposedRefs } from "@/shared/lib/data-table/compose-refs";
...
interface SortableItemProps extends Omit<React.ComponentProps<"div">, "ref"> {
...
interface SortableItemHandleProps extends Omit<
