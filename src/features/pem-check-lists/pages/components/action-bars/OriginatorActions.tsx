  ...
  return (
    <button
      ...
      className={cn(
        ...
        "font-helvetica-now text-grey-50 font-helvetica-now text-grey-50 rounded-sm flex h-8 lg:h-10 items-center justify-center gap-1.5 px-3.5 text-xs leading-(--line-height-300) font-medium tracking-normal uppercase transition-colors lg:h-10 lg:text-sm focus-visible:ring-ring focus-visible:ring-2 focus-visible:outline-none bg-primary-600 hover:bg-primary-500 flex h-8 items-center justify-center gap-1.5 px-3.5 text-xs leading-(--line-height-300) font-medium tracking-normal uppercase transition-colors lg:h-10 lg:text-sm",
